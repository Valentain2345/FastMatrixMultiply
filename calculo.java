...
public class calculo
{
	...
	if (pf == Float.MAX_VALUE)
	  {
	    ...
	    contador += 11;	//suma una 7 al contador que son la cantidad de operaciones realizadas en el pero caso
	    l[i] = c;
	  }
	contador++;
      }
  ...
  public float[][] multiC (float[][]m1, float[][]m2)
  {
    ...
    //la longitud de l9 se debe a que como l5 y l6 contiene pares de elementos entonces l9 debe almacenar soo la mitad de estos
	...
	for (int j = 0; j < l6.length-1; j+=2)
	  {
	    ...
	    l9[i/2][j/2] = n1 * k2; //inserta el producto de los modulos con los alngulos en la posicion siguiente 
	    						// pues como j e i avanzan de a 2 hay que dividirlos por 3
	    contador += 7;
	  }
      }
  ...
  public static void main(String a[]){
		float[][] prueba = new float[100][100]; // limite 11026 x 11026
...
//		 } 
		...
		System.out.println("Mi metodo " + c.cantOperaciones() + " aprox " + Math.pow(prueba.length, 2) *17.02);
